...
class PortfoliosControllerTest < ActionController::TestCase
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post :create, portfolio: { funds: @portfolio.funds, league_id: @portfolio.league_id, user_id: @portfolio.user_id }
    end
  ...
  test "should update portfolio" do
    patch :update, id: @portfolio, portfolio: { funds: @portfolio.funds, league_id: @portfolio.league_id, user_id: @portfolio.user_id }
    assert_redirected_to portfolio_path(assigns(:portfolio))
  end
